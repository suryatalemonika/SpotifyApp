...
fetchcall('access_token', (token) => {
    ...
    const data = {
        context_uri: 'spotify:album:6lPfJpZ1Yly71dDOlOuMK7',//'spotify:album:49UKgxbscTVjFrDxBtsupW',
        offset: {
            position: 5
        },
        position_ms: 0,
        device_id: '35b07192d1d19336409f2e7104bc80cfabce3bcc' // Replace with the actual device_id
